...
- Many people asked how can this manual be "mini", since it is pretty
  big for an single page article. Yes, if this page is exported to
  PDF, it is more than 40 pages. However, this manual is "mini"
...
- =diff= between editting file and latest file revision:
...
tedious and interrupt your thoughts.
...
You may wonder, what happens if the kill ring keeps getting really
large? That's right. It's a problem, and that's when the 3rd party
plugins shine.
