...
#+begin_src fundamental
  ...
  machine3=(aa:bb:cc:dd:ee:b1 aa:bb:cc:dd:ee:b2 aa:bb:cc:dd:ee:b3)
  machine4=(aa:bb:cc:dd:ee:c1 aa:bb:cc:dd:ee:c2 aa:bb:cc:dd:ee:c3)
  machine5=(aa:bb:cc:dd:ee:d1 aa:bb:cc:dd:ee:d2 aa:bb:cc:dd:ee:d3)
  machine6=(aa:bb:cc:dd:ee:e1 aa:bb:cc:dd:ee:e2 aa:bb:cc:dd:ee:e3)
  machine7=(aa:bb:cc:dd:ee:f1 aa:bb:cc:dd:ee:f2 aa:bb:cc:dd:ee:f3)
#+end_src
...
- _Pre-recording setup_:
  ...
  - Yank the original data into =buf1=. Move point back to
    ...
    That's set and done. Numbered registers are used for storing
    buffer positions and uppercase-character register =A= is used for
    storing text template. This convention helps us to remember which
    register to save content into.
