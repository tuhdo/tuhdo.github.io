...
:END:
*_NOTE_*: Before you start, please remember that you can always access
a section using the floating table of content on the upper-right
corner of your screen. Now, let's start your Emacs journey.
...
prompt, press *RET*. For quickly running =file-file=, you can use key
binding *C-x C-f*.
...
:END:
One of the best of use of register. It simly saves your window
configuration at the moment and restore the layout later. 
