...
such a extension. We will discuss more on extension packages later.
...
An application window in a operating system is called a *Frame* in
...
extensibility, Emacs can be  things: an editor, a file manager, an
