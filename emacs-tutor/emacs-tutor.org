...
are window configuration, text region and number. For these others, I
...
| Key           | Binding                                                                      |
|---------------+------------------------------------------------------------------------------|
| =C-x r w Reg= | Save the window configuration of current frame into register *Reg*           |
|---------------+------------------------------------------------------------------------------|
| =C-x r f Reg= | Save the state of all frames, including all their windows, in register *Reg* |
|---------------+------------------------------------------------------------------------------|
