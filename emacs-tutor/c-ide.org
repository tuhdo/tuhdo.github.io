...
- Show function interface at the bottom:
...
=helm-man-woman=, which is bound to *C-c h m* if you follow [[file:~/Public/blog/publish/share/helm.org][my guide]].
