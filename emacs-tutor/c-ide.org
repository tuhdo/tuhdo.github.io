...
fast using =helm-gtags-select=, which is bound to =M-s= in my setup
...
:PROPERTIES:
:ID:       315bd019-f3b2-4d9e-a4b4-6b9dbfa7abde
:END:
...
- Automatically switches to the directory of the current buffer.
...
:PROPERTIES:
:ID:       b07dd821-77f5-4158-81e2-234d99b54b90
:END:
...
:PROPERTIES:
:ID:       ecceaa7c-6e0e-477a-b59c-3c636b4afe1d
:END:
...
to =semantic-c-dependency-system-include-path=. By default, it
only contains =/usr/include=.

** Using generated database from =GNU Global=
:PROPERTIES:
:ID:       ba935604-930b-4e12-b2a4-673cedc3453b
:END:
