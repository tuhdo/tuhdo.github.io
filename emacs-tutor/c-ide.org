...
To solve this problem, we need to redefine
=semantic-stickyfunc-fetch-stickyline= function. If you don't
understand, that's ok. Just copy and paste into your init file, it
will work:
