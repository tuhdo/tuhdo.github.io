...
* Java Renaissance (Less is better)
  ...
  [[file:static/5800x_m1_charts/Java Renaissance Benchmarks.png][file:static/5800x_m1_charts/Java Renaissance Benchmarks.png]]
...
* Java SciMark 2.0 (Higher is better)
  ...
  [[file:static/5800x_m1_charts/Java SciMark 2.0 Benchmarks (NIST).png][file:static/5800x_m1_charts/Java SciMark 2.0 Benchmarks (NIST).png]]
...
* Java DaCapo (Less is better)
  ...
  [[file:static/5800x_m1_charts/Java DaCapo Benchmarks (309e1fa).png][file:static/5800x_m1_charts/Java DaCapo Benchmarks (309e1fa).png]]
...
* Python PyPerformance (Less is better)
  ...
  [[file:static/5800x_m1_charts/PyPerformance Benchmarks.png][file:static/5800x_m1_charts/PyPerformance Benchmarks.png]]

  [[file:static/5800x_m1_charts/PyPerformance Benchmarks (Total Seconds Elapsed).png][file:static/5800x_m1_charts/PyPerformance Benchmarks (Total Seconds Elapsed).png]]
...
* Redis
  ...
  [[file:static/5800x_m1_charts/Redis v6.0.9 Benchmark (1,000,000 Requests).png][file:static/5800x_m1_charts/Redis v6.0.9 Benchmark (1,000,000 Requests).png]]

* JavaScript Web Tooling Benchmark (v8) (Higher is better)
  
  The 5800X is significatnly faster in most benchmarks:
  
  [[file:static/5800x_m1_charts/JavaScript Web Tooling Benchmark (v8).png][file:static/5800x_m1_charts/JavaScript Web Tooling Benchmark (v8).png]]

* JavaScript Octane 2.0 (Higher is better)

  Same story as above: 

  [[file:static/5800x_m1_charts/JavaScript Octane 2.0.png][file:static/5800x_m1_charts/JavaScript Octane 2.0.png]]

  [[file:static/5800x_m1_charts/JavaScript Octane 2.0 Overall.png][file:static/5800x_m1_charts/JavaScript Octane 2.0 Overall.png]]
