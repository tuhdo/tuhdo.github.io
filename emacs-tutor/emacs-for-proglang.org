...
- *C-M-<SPC>* or *C-M-@* binds to =mark-sexp=, put mark after
  ...
  Automatic indentation: =aggressive-indent=.
...
- Evaluate expressions with *C-x C-e* or compile it. You can evaluate
  individual expression or a region of expressions.
- See result in REPL buffer.
...
*** Feature showcase
:PROPERTIES:
:ID:       2199e65b-eddd-460f-89d3-cca5206d822f
:END:
**** Autodoc: =geiser-autodoc-show=
:PROPERTIES:
:ID:       6e1d7aa7-78ac-458f-9e01-974a418c4644
:END:
The echo area shows information about the signature of the
procedure/macro around point automatically. It is enabled by default
...
:PROPERTIES:
:ID:       912d6020-6f5f-4528-8895-d677e62f7c1a
:END:
***** Command: =geiser-doc-symbol-at-point=, *C-c C-d C-d*
:PROPERTIES:
:ID:       f978a7a6-c798-48f1-98a6-536d63151a27
:END:
_Usage_: See documentation for identifier at point

***** Command: =geiser-doc-module=, *C-c C-d C-m*
:PROPERTIES:
:ID:       87526305-c7f8-450c-bc73-71b3c73bec0c
:END:
***** Command: =geiser-doc-look-up-manual=, 
:PROPERTIES:
:ID:       4beb831a-e246-4496-9b0f-d6ac3ba73a0a
:END:
_Usage_: Look up manual for symbol at point
...
**** Jump to definition of identifier at point.
:PROPERTIES:
:ID:       3de18238-7758-434b-b7c1-8175524112c3
:END:

**** Context-sensitve completion
:PROPERTIES:
:ID:       12a89f0f-a618-43d9-b254-1e33c6542331
:END:

**** Form evaluation in the context of the current file’s module.
:PROPERTIES:
:ID:       f44a2558-5325-4514-8108-5b4ed5073df1
:END:
***** Command: =geiser-eval-definition=, *C-M-x*
:PROPERTIES:
:ID:       e9241492-d43c-4d3f-b197-3733dc2ffff1
:END:
***** Command: =geiser-eval-last-sexp=, *C-x C-e*
:PROPERTIES:
:ID:       f8f3d091-d395-4ae8-a317-c452c408c1e1
:END:
***** Command: =geiser-eval-region=, *C-c C-r*
:PROPERTIES:
:ID:       171c2e79-2031-4d4a-8f73-bf34bfb3356a
:END:
***** Command: =geiser-eval-buffer=, *C-c C-b*
:PROPERTIES:
:ID:       5d824d78-59d7-49fe-8486-29fe129f387f
:END:
***** Summary
:PROPERTIES:
:ID:       a8cad826-b5db-40f2-89b8-53ce1fb8e0e7
:END:
...
:PROPERTIES:
:ID:       d63644ea-75a1-4ea0-be3d-ec46f2bfdf5f
:END:
...
:PROPERTIES:
:ID:       25160aea-0645-47bf-98af-b79f4e73b269
:END:
**** Debugging
:PROPERTIES:
:ID:       e537b0ee-cbc5-48c8-a6e0-b699b936a68d
:END:

**** Macro expansion.
:PROPERTIES:
:ID:       30e67003-9aaf-45c7-90e5-91baed2b2719
:END:
**** File/module loading and/or compilation.
:PROPERTIES:
:ID:       9a142adc-5659-4bc7-a70b-526e98d69580
:END:
**** Listings of identifiers exported by a given module.
:PROPERTIES:
:ID:       28e98d91-3b07-44ad-9ddd-39996c0af556
:END:

**** Listings of callers/callees of procedures (only available in Guile Scheme).
:PROPERTIES:
:ID:       139334df-a664-4f70-ae3d-273df8550046
:END:

**** Support for multiple, simultaneous REPLs
:PROPERTIES:
:ID:       93f8ad18-d97b-451c-b304-f42ce7affe80
:END:
