...
- ~Find File~ (default action bound to *RET*): open files; if multiple
  ...
  marked using *M-a*, all marked files are opened, as in the [[*Select%20and%20open%20multiple%20files][Select
...
This command is demonstrated at the beginning: [[*Open%20file%20at%20point%20anywhere][Open file at point
anywhere]].
