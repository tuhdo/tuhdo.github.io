...
without losing your old marks. For example, at the beginning I want to
...
files and mark the needed files, without losing the marking on the
files that contains "aaaa".
