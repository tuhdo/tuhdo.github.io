...
You can filter out buffers by major mode using =*<major-mode>=. For
example, =*dired= selects only Dired buffers.

You can even use =helm-mini= to filter out buffers that contains a
regexp.
...
*** Package: =ido=
:PROPERTIES:
:ID:       46ac2c65-1713-46fb-8a93-3b6032ca534b
:END:
*** Package: =flx-ido=
:PROPERTIES:
